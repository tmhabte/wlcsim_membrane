...
print("efficient, coarse is 0.01!")
...
phi_a_i_fine = np.arange(0.1, 1 + del_phi_a_i / res_factor, del_phi_a_i / res_factor)
phi_b_i_fine = np.arange(0.1, 1 + del_phi_a_i / res_factor, del_phi_a_i / res_factor)
...
#-------------------------------------------------------------------------------------------------
# MORE EFFICIENT border identification
#------------------------------------------------------------------------------------------------
...
band_thickness = 10*res_factor      # or 1, 3, 5 … depending on refinement needs
...
#-------------------------------------------------------------------------------------------------
# MORE EFFICIENT BOUNDARY phase calculation
#------------------------------------------------------------------------------------------------
print("starting boundary phase calc")
