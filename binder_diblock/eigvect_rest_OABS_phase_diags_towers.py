...
np.save("OABS_phases_arr_eigvecrest_chiABphipNeq"+str(int(chi_AB*phi_p*N))+"N="+str(int(N)), phases)
np.save("OABS_min_F_arr_eigvecrest_chiABphipNeq"+str(int(chi_AB*phi_p*N))+"N="+str(int(N)), minF_arr)
