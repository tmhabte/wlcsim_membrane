# import numpy as np
from expl_bind_beaker_corr_calc import *

def gamma2_chis(psol, s_bnd_A, s_bnd_B, phis, K):
    ...
    S2_mat = calc_sf2(psol, corrs, phis, K)
    # print(S2_mat)
    # S2_mat[-1,-1] *= (N / M)
...
def gamma3(psol, s_bnd_A, s_bnd_B, phis, Ks):
    ...
    #calc sf2
    S2_inv_red = sf2_inv_raw(psol, corrs, phis, K1)
    S2_inv_red_2 = sf2_inv_raw(psol, corrs, phis, K2)
    S2_inv_red_3 = sf2_inv_raw(psol, corrs, phis, K3)
    # print("S2_inv: ", S2_inv_red, S2_inv_red_2, S2_inv_red_3)


    # print("vm=A=1")
    s3 = calc_sf3(psol, corrs, phis, K1, K2, K3)
    # s3[3,3,3] *=  N/M
    # print("s3:", s3)
...
def gamma4(psol, s_bnd_A, s_bnd_B, phis, Ks):
    K1, K2, K3, K4 = Ks
    ...
    s4 = calc_sf4(psol, corrs, phis, K1, K2, K3, K4) 
    s3_12 = calc_sf3(psol, corrs, phis, K1, K2, -K1-K2)
    s3_14 = calc_sf3(psol, corrs, phis, K1, K4, -K1-K4)
    s3_23 = calc_sf3(psol, corrs, phis, K2, K3, -K2-K3)
    s3_24 = calc_sf3(psol, corrs, phis, K2, K4, -K2-K4)
    s3_34 = calc_sf3(psol, corrs, phis, K3, K4, -K3-K4)
    s3_13 = calc_sf3(psol, corrs, phis, K1, K3, -K1-K3)

    
    S2_inv_red = sf2_inv_raw(psol, corrs, phis, K)
    S2_inv_red_12 = sf2_inv_raw(psol, corrs, phis, K12)
    S2_inv_red_13 = sf2_inv_raw(psol, corrs, phis, K13)
    S2_inv_red_14 = sf2_inv_raw(psol, corrs, phis, K14)

    S2_inv_red_2 = sf2_inv_raw(psol, corrs, phis, K2)
    S2_inv_red_3 = sf2_inv_raw(psol, corrs, phis, K3)
    S2_inv_red_4 = sf2_inv_raw(psol, corrs, phis, K4)
